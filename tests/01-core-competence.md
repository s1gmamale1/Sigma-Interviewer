...
- Per-dimension 0–10 scores **each with a quote** (e.g. Eng 4, Behav 4, Complete 3, AI 3, Critical 4, Decision 3, Arch 4)
...
**Pass if:** fit = Maybe-trial, core in the 50–65 band, dims scored 0–10 with quotes.
